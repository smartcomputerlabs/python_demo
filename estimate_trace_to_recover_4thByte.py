...
for kb in range(256):
    ...
    with open(myfile) as csv_file:
        ...
        for row in csv_reader:
            ct = int(row[1],10)
            #print hex(ct)
            ct_binary = np.binary_repr(ct,128) #get the binary representation of integer,ct in string format of size 128
            ct_temp = int(ct_binary[32:40], 2)# get the 4thByte
            #print hex(ct_temp)
